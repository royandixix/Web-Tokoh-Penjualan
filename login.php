...
if (isset($_SESSION["login"])) {
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $hasil['password'])) {
            ...
            // jika login benar arahan index.php
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
        <button class="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center" id="bd-theme" type="button"
            aria-expanded="false" data-bs-toggle="dropdown" aria-label="Ganti tema (otomatis)">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="" method="POST">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" name="login">Masuk</button>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/5.3.1/js/bootstrap.bundle.min.js"
        integrity="sha384-OH68wM/WZj/JLUq9iN4h4W1TuEELnqWz6d9vcxgE6A/r8ioZ4ZON5zYo6ojF1J8C"
